  ...
  const searchThreads = /* @__PURE__ */ __name(async (keyword) => {
    ...
    try {
      ...
      for (const t of res.TopicArray.slice(0, 6)) {
        ...
        const dt = new Date(t.DateUpdated * 1e3);
        ...
        items.push({
          ...
          title: t.Title,
          author: t.UserName,
          cover: t.Background && !t.Background.includes("avatar") && !t.Background.includes("upload") ? t.Background : void 0,
          tags: tags.slice(0, 8),
    ...
    const html = `<!DOCTYPE html><html><head><style>
      ...
      return `<div class="item"><div class="cover-box">${bg}</div><div class="content">
              ...
              <div class="meta-row">
                ...
                <span class="stat" style="color:#ffc107">${ICONS.followers}<span>${r.stats.followers || 0}</span></span>
